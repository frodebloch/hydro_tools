...
|--------------------------------------+-------+--------+-------+-------+-------+-------|
| Standard, no rotor [kg/voyage]       | 17378 |  17241 | 15910 | 19444 | 10816 | 23079 |
| Optimiser + rotor [kg/voyage]        | 15120 |  15147 | 12949 | 17443 |  8107 | 21971 |
| Propeller optimisation saving [kg]   |   851 |    883 |   729 |   936 |   409 |   981 |
| Wind-assist saving [kg]              |  1407 |   1245 |   360 |  2660 |     3 |  4847 |
| Propeller optimisation saving        | 4.9@@latex:\%@@ | 5.1@@latex:\%@@ | 3.9@@latex:\%@@ | 5.7@@latex:\%@@ | 2.6@@latex:\%@@ | 6.4@@latex:\%@@ |
| Wind-assist saving                   | 8.3@@latex:\%@@ | 7.1@@latex:\%@@ | 2.0@@latex:\%@@ | 16.6@@latex:\%@@ | 0.0@@latex:\%@@ | 28.6@@latex:\%@@ |
...
| Standard control + Flettner rotor |             1167.4 |
| Optimiser, no rotor               |             1208.5 |
| Optimiser + Flettner rotor        |             1105.6 |

#+ATTR_LATEX: :booktabs t :align lrr
| Saving component          | Tonnes/year | Percentage          |
|---------------------------+-------------+---------------------|
| Propeller optimisation    |        62.3 | 4.9@@latex:\%@@     |
| Wind-assist (Flettner)    |       102.9 | 8.1@@latex:\%@@     |
...
|-----------------------------------+-----------------------------------------|
| Standard control, no rotor        | @@latex:\euro@@826\thinspace036         |
| Standard control + Flettner rotor | @@latex:\euro@@758\thinspace839         |
| Optimiser, no rotor               | @@latex:\euro@@785\thinspace543         |
| Optimiser + Flettner rotor        | @@latex:\euro@@718\thinspace687         |

#+ATTR_LATEX: :booktabs t :align lrr
| Saving component          | @@latex:\euro@@/year             | Percentage          |
|---------------------------+---------------------------------+---------------------|
| Propeller optimisation    | @@latex:\euro@@40\thinspace494  | 4.9@@latex:\%@@     |
| Wind-assist (Flettner)    | @@latex:\euro@@66\thinspace855  | 8.1@@latex:\%@@     |
| *Combined*                | *@@latex:\euro@@107\thinspace349* | *13.0@@latex:\%@@*  |
...
|---------------+---------+--------------+-----------------+---------------------+--------------------|
| Q1 (Jan--Mar) |      91 | 17\thinspace420 | 14\thinspace835 | 4.7@@latex:\%@@  | 10.4@@latex:\%@@   |
| Q2 (Apr--Jun) |      91 | 17\thinspace519 | 15\thinspace607 | 5.1@@latex:\%@@  | 6.0@@latex:\%@@    |
| Q3 (Jul--Sep) |      92 | 17\thinspace348 | 15\thinspace377 | 5.1@@latex:\%@@  | 6.3@@latex:\%@@    |
| Q4 (Oct--Dec) |      88 | 17\thinspace220 | 14\thinspace642 | 4.9@@latex:\%@@  | 10.4@@latex:\%@@   |
...
propeller optimisation saving remains stable at 4.7--5.1@@latex:\%@@ year-round,
...
| Standard control + Flettner rotor |             1452.3 |
| Optimiser, no rotor               |             1535.4 |
| Optimiser + Flettner rotor        |             1453.3 |

#+ATTR_LATEX: :booktabs t :align lrr
| Saving component          | Tonnes/year | Percentage           |
|---------------------------+-------------+----------------------|
| Propeller optimisation    |         0.3 | 0.0@@latex:\%@@      |
| Wind-assist (Flettner)    |        82.1 | 5.3@@latex:\%@@      |
| *Combined*                |    *82.4*   | *5.4@@latex:\%@@*    |

At MGO @@latex:\euro@@650/tonne, the annual saving with SG active is
@@latex:\euro@@54\thinspace000/year (5.4@@latex:\%@@).
...
pitch.  As a result, the *propeller optimisation saving drops to
0.0@@latex:\%@@* with the SG active --- all of the combined saving comes from
the Flettner rotor.
...
(5.3@@latex:\%@@ vs 8.1@@latex:\%@@) because the SG-loaded baseline
consumption is higher (\SI{1536}{t/yr} vs \SI{1271}{t/yr}).

#+ATTR_LATEX: :booktabs t :align lrrrrr
| Season        | Voyages | Std [kg/voy] | Opt+Fl [kg/voy] | Prop. opt.          | Wind-assist        |
|---------------+---------+--------------+-----------------+---------------------+--------------------|
| Q1 (Jan--Mar) |      91 | 20\thinspace991 | 19\thinspace554 | 0.1@@latex:\%@@  | 6.9@@latex:\%@@    |
| Q2 (Apr--Jun) |      91 | 21\thinspace148 | 20\thinspace330 | -0.0@@latex:\%@@ | 3.9@@latex:\%@@    |
| Q3 (Jul--Sep) |      92 | 20\thinspace990 | 20\thinspace135 | -0.1@@latex:\%@@ | 4.1@@latex:\%@@    |
| Q4 (Oct--Dec) |      88 | 20\thinspace870 | 19\thinspace460 | 0.0@@latex:\%@@  | 6.8@@latex:\%@@    |
...
| Propeller optimisation saving          | 4.9@@latex:\%@@ (62 t/yr) | 0.0@@latex:\%@@ (0.3 t/yr) |
| Wind-assist saving                     | 8.1@@latex:\%@@ (103 t/yr) | 5.3@@latex:\%@@ (82 t/yr) |
...
21@@latex:\%@@ due to the parasitic load.  Critically, the SG RPM floor
...
|--------------------+-------------------+-------------------+--------------------|
| \SI{10}{\knot}     | 0.0@@latex:\%@@   | 5.3@@latex:\%@@   | 5.4@@latex:\%@@    |
...
effective SFOC includes an /opportunity cost/.  Without the SG the Optimiser
selects ~\SI{75}{RPM} shaft (\SI{510}{RPM} engine) at \SI{10}{\knot}, deep in
...
plus the total loss of the Optimiser's 4.9@@latex:\%@@ pitch/RPM saving.
...
(@@latex:\euro@@16\thinspace000/year) in fuel compared to the shaft generator.
...
1. *The Optimiser* saves *4.9@@latex:\%@@* of fuel (62 tonnes/year,
...
2. *Flettner rotor wind-assist* saves an additional *8.1@@latex:\%@@*
   (103 tonnes/year, @@latex:\euro@@67\thinspace000/year), varying with wind
   conditions -- roughly 6@@latex:\%@@ in summer and 10@@latex:\%@@ in winter.

3. *Combined saving: 13.0@@latex:\%@@* (165 tonnes/year,
   @@latex:\euro@@107\thinspace000/year).

*With shaft generator (SG online, 150 kW, 48--60 Hz):*

4. [@4] The SG increases baseline fuel by approximately 21@@latex:\%@@ due to the
   ...
   *eliminating the pitch/RPM saving entirely* (0.0@@latex:\%@@).

5. The *Flettner rotor remains effective at 5.3@@latex:\%@@* (82 tonnes/year).
...
6. *Combined saving with SG: 5.4@@latex:\%@@* (82 tonnes/year,
   @@latex:\euro@@54\thinspace000/year).
...
7. *Shaft generator vs auxiliary genset:* At \SI{10}{\knot}, the effective fuel
   ...
   save approximately @@latex:\euro@@16\thinspace000/year.
