...
\caption{\label{fig:org901be15}Rotterdam--Gothenburg route (509 nm one-way) with waypoints.}
\end{figure}

\section{Results}
\label{sec:org54e9427}

362 round-trip voyages were successfully simulated across the full year 2024.

\subsection{Per-Voyage Fuel Consumption}
\label{sec:org32021b9}
...
Figure \ref{fig:orgf4991ad} shows how the savings evolve over the year, alongside
the sea conditions that drive them.

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{voyage_comparison_results.png}
\caption{\label{fig:orgf4991ad}Annual results per voyage.  Top: propeller optimisation and wind-assist fuel savings (stacked).  Middle: significant wave height.  Bottom: wave resistance, wind resistance, and Flettner rotor thrust.}
\end{figure}

\subsection{Weather Correlation}
\label{sec:org3111521}

Figure \ref{fig:org233f5e8} shows how the fuel saving on each voyage correlates with
...
\caption{\label{fig:org233f5e8}Per-voyage fuel saving vs mean wave height, coloured by mean wind speed.  Windier conditions produce larger savings through the Flettner rotor.}
\end{figure}

\subsection{Annualised Fuel Consumption}
\label{sec:orga64e4b8}
...
Figure \ref{fig:orgf9bbb04} shows the distribution of per-voyage savings.  The
...
\caption{\label{fig:orgf9bbb04}Distribution of per-voyage fuel savings.  Left: total saving.  Centre: propeller optimisation component.  Right: wind-assist component.}
\end{figure}

\subsection{Annual Cost Savings}
\label{sec:org7a95115}
...
\label{sec:org5be03cc}
\subsection{Why It Matters}
\label{sec:orgb282837}
